                ...
                <div class="primary-menu-list main-menu-modal cover-modal" data-modal-target-string=".main-menu-modal">
                    ...
                    <div class="mobile-menu" aria-label="<?php esc_attr_e('Mobile', 'jobscout'); ?>">
                        ...
                        <?php if ($post_job_label || $post_job_url) { ?>
                            <div class="btn-wrap">
                                <a class="btn" href="<?php echo esc_url($post_job_url) ?>">
    ...
    { ?>
        <div id="page" class="site">
            <a class="skip-link screen-reader-text" href="#acc-content">
                <?php esc_html_e('Skip to content (Press Enter)', 'jobscout'); ?>
            </a>
            <?php
    }
endif;
    ...
    function jobscout_header()
    {
        ?>
            <header id="masthead" class="site-header header-one" itemscope itemtype="https://schema.org/WPHeader">
                <?php if (has_nav_menu('secondary') || current_user_can('manage_options'))
                    jobscout_secondary_navigation(); ?>
                            ...
                            if (get_option('job_manager_enable_types')) {
                                ...
                                if (!empty($types)):
                                    foreach ($types as $type): ?>
                                        <span class="btn <?php echo esc_attr(sanitize_title($type->slug)); ?>">
            ...
            if ($previous || $next) { ?>
                                <nav class="navigation post-navigation" role="navigation">
                                    <h2 class="screen-reader-text">
                                        <?php esc_html_e('Post Navigation', 'jobscout'); ?>
                                    </h2>
                                    <div class="nav-links">
                                        <?php
                                        if ($previous)
...
if (!function_exists('jobscout_author')):
    ...
    function jobscout_author()
    {
        ...
        if (!$ed_author && get_the_author_meta('description')) { ?>
                            <div class="author-bio">
                                <?php if ($author_title)
                                    echo '<h3 class="title">' . esc_html($author_title) . '</h3>'; ?>
                    ...
                    <div class="footer-b">
                        <div class="container">
                            ...
                            if (function_exists('the_privacy_policy_link'))
                                the_privacy_policy_link('<div class="privacy-block">', '</div>');
                            ?>
                            <div class="copyright">
                                <?php
