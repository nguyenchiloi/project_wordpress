				...
				if (get_option('job_manager_enable_types')) {
					...
					if (!empty($types)):
						foreach ($types as $jobtype): ?>
							<div class="chinhcss1">
								<div class="noidung-khung-search"><?php echo esc_html($jobtype->name); ?></div> 
								<span class="keduong2ben">|</span>
								<div class="noidung-khung-search"> <?php the_company_name(); ?></div>
								<span class="keduong2ben">|</span>
								<div class="noidung-khung-search"> <?php the_job_location(true); ?></div>
							</div>
